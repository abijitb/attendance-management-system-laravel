...
@section('content')
      ...
      <div><a href="{{ URL::to('/start/'.rtrim(strtr(base64_encode($class->cla_id), '+/', '-_'), '=')) }}"><i class="ion-arrow-left-a"></i></a> Subjects</div>
		</h1>
                    	...
                    	<form method="POST" action="{{ URL::to('/subjects') }}" class="needs-validation" novalidate="">
		                  ...
		                  <div class="row">
		                    <div class="form-group col-12">
		                      ...
		                      <input type="hidden" name="bach_id" value="{{ $batch->bach_id }}" required>
			...
			<div class="col-lg-5">
				...
				<div class="card card-primary">
                  ...
                  <div class="card-body ">
		                  ...
		                  <div class="row">
		                  	<div class="form-group col-12">
		                      <label for="select_subject_name">Subject Name</label>
		                      <select type="text" name="select_subject_name" id="select_subject_name" class="form-control" onchange="goToNext(this)">
		                     		<option value="">-- Select Subject --</option>
		                     	@foreach($subjects as $subject)
		                     		<option value="{{ rtrim(strtr(base64_encode($subject->sbjt_id), '+/', '-_'), '=') }}">{{ $subject->sbjt_name }}</option>
		                     	@endforeach
		                      </select>
		                    </div>
		                  </div>
